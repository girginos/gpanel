...
func main() {
	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.With(middleware.AdminOnly).Get("/antivirus/domainler", avH.AdminDomainler)
			r.With(middleware.AdminOnly).Post("/antivirus/domainler/{id}/tara", avH.Tara)
			r.With(middleware.AdminOnly).Get("/antivirus/domainler/{id}/tara/{sid}", avH.TaraDurum)
			...
			r.With(middleware.AdminOnly).Get("/system/tasima/oturumlar", tasimaH.OturumListe)
			r.With(middleware.AdminOnly).Get("/system/tasima/oturum/{id}", tasimaH.OturumGetir)
			r.With(middleware.AdminOnly).Delete("/system/tasima/oturum/{id}", tasimaH.OturumSil)
			...
			r.Group(func(r chi.Router) {
				...
				r.With(middleware.MusteriScope).Put("/domains/{id}/cron/{idx}", cronH.Update)
