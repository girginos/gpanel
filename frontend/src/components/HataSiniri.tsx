        ...
        <div className="max-w-lg w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm p-6">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              <h1 className="text-base font-semibold text-slate-900 dark:text-slate-100">Bu sayfa görüntülenemedi</h1>
              <p className="mt-1.5 text-sm text-slate-500 dark:text-slate-400">
                Beklenmeyen bir hata oluştu. Panelin diğer bölümleri çalışmaya devam ediyor —
                sayfayı yenilemeyi ya da bir önceki ekrana dönmeyi deneyin.
              </p>
            </div>
          </div>
