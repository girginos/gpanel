...
export const I: Record<string, string> = {
  ...
  roket: 'M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.7-.84.7-2.13-.1-2.9a2.18 2.18 0 0 0-2.9-.1zM12 15l-3-3a22 22 0 0 1 2-3.95A12.9 12.9 0 0 1 22 2c0 2.72-.78 7.5-6 11a22 22 0 0 1-4 2zM9 12H4s.55-3 2-4c1.6-1.08 5 0 5 0M12 15v5s3-.55 4-2c1.08-1.6 0-5 0-5',
  simsek: 'M13 2 3 14h9l-1 8 10-12h-9z',
  durakla: 'M6 4h4v16H6zM14 4h4v16h-4z',
  harici: 'M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6M15 3h6v6M10 14 21 3',
  yukari: 'M12 19V5M5 12l7-7 7 7',
  asagi: 'M12 5v14M19 12l-7 7-7-7',
  anten: 'M4.9 19.1a10 10 0 0 1 0-14.2M7.8 16.2a6 6 0 0 1 0-8.4M16.2 7.8a6 6 0 0 1 0 8.4M19.1 4.9a10 10 0 0 1 0 14.2M13 12a1 1 0 1 0-2 0 1 1 0 0 0 2 0z',
  saat: 'M12 6v6l4 2M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20',
  bulut: 'M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z',
  grafik: 'M3 3v18h18M18 9l-5 5-3-3-4 4',
  arac: 'M14.7 6.3a4 4 0 0 0-5.4 5.4L3 18l3 3 6.3-6.3a4 4 0 0 0 5.4-5.4l-2.6 2.6-2.4-2.4z',
  ban: 'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20zM5 5l14 14',
  link: 'M10 13a5 5 0 0 0 7 0l3-3a5 5 0 0 0-7-7l-1 1M14 11a5 5 0 0 0-7 0l-3 3a5 5 0 0 0 7 7l1-1',
  parca: 'M19 11h-2V9a2 2 0 0 0-2-2h-2V5a2 2 0 0 0-4 0v2H7a2 2 0 0 0-2 2v2H3a2 2 0 0 0 0 4h2v2a2 2 0 0 0 2 2h2v-2a2 2 0 0 1 4 0v2h2a2 2 0 0 0 2-2v-2h2a2 2 0 0 0 0-4z',
  tamEkran: 'M8 3H5a2 2 0 0 0-2 2v3M21 8V5a2 2 0 0 0-2-2h-3M3 16v3a2 2 0 0 0 2 2h3M16 21h3a2 2 0 0 0 2-2v-3',
  geriAl: 'M3 7v6h6M3 13a9 9 0 1 0 3-7.7L3 8',
