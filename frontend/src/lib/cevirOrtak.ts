...
export const ORTAK_EN: Record<string, string> = {
  ...
  "Linux kullanıcı, nginx vhost, PHP-FPM havuzu, FTP hesabı ve DNS zone otomatik kurulur.": "Linux user, nginx vhost, PHP-FPM pool, FTP account and DNS zone are set up automatically.",
