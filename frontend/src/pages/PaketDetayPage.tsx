...
export default function PaketDetayPage() {
  ...
  if (!plan) return <div className="px-4 py-4 sm:px-6 sm:py-5"><div className="text-sm text-red-600">{hata || 'Plan bulunamadı'}</div></div>
                ...
                <tbody className={T.govde}>
                  {domainler.map(d => (
                    <tr key={d.id} className={`${T.satir} lg:hover:bg-slate-50 dark:lg:hover:bg-slate-800/60`}>
                      ...
                      <td className={T.hucre} data-etiket="Oluşturma">
